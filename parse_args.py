...
def parse_args():
    ...
    parser.add_argument('--corpus_mode', type=str, default='chn', choices=['random', 'chn', 'eng', 'cardid', 'name', 'sohu'],
                        help='Different corpus type have different load/get_sample method'
                             ...
                             'cardid: pick cardid number from corpus'
                             'name: pick ID name from corpus'
                             'sohu: pick continuous chars from news_sohu corpus')
