...
class LineState(object):
    ...
    middleline_thickness_p = [0.1, 0.8, 0.1]
...
class Liner(object):
    ...
    def apply_under_line(self, word_img, text_box_pnts, word_color):
        ...
        word_color = np.asarray(word_color).mean()
    ...
    def apply_middle_line(self, word_img, text_box_pnts, word_color):
        ...
        img_mean = int(np.mean(word_img)) - random.randint(10, 40)
        ...
        dst = cv2.line(word_img,
                       ...
                       color=(img_mean, img_mean, img_mean),
                       thickness=thickness,
                       lineType=cv2.LINE_AA)
